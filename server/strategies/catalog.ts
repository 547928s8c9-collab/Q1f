...
export const STRATEGY_PROFILE_CATALOG: StrategyProfileCatalogEntry[] = [
  ...
  {
    slug: "xrp_stable_arb",
    displayName: "XRP Stable Arb",
    symbol: "XRPUSDT",
    timeframe: "1h",
    description: "Statistical arbitrage on XRP exploiting short-term mean deviation in low-volatility regimes.",
    riskLevel: "LOW",
    tags: ["arbitrage", "low-vol", "mean-reversion"],
    defaultConfig: {
      ...baseConfig,
      feesBps: 7,
      slippageBps: 4,
  ...
  {
    slug: "bnb_range_harvest",
    displayName: "BNB Range Harvest",
    symbol: "BNBUSDT",
    timeframe: "1h",
    description: "Harvests yield from BNB price oscillations within established range channels.",
    riskLevel: "LOW",
    tags: ["range", "yield", "defensive"],
    defaultConfig: {
      ...baseConfig,
      feesBps: 8,
      slippageBps: 5,
  ...
  {
    slug: "eth_grid_scalp",
    displayName: "ETH Grid Scalp",
    symbol: "ETHUSDT",
    timeframe: "15m",
    description: "Grid-based scalping on ETH with EMA-guided entry levels and volume confirmation.",
    riskLevel: "CORE",
    tags: ["grid", "scalp", "volume"],
    defaultConfig: {
      ...baseConfig,
      feesBps: 13,
      slippageBps: 9,
  ...
  {
    slug: "ada_macd_cross",
    displayName: "ADA MACD Cross",
    symbol: "ADAUSDT",
    timeframe: "1h",
    description: "MACD crossover strategy on ADA with histogram momentum confirmation.",
    riskLevel: "CORE",
  ...
  {
    slug: "btc_lev_momentum",
    displayName: "BTC Lev Momentum",
    symbol: "BTCUSDT",
    timeframe: "15m",
    description: "Leveraged momentum strategy on BTC riding strong directional moves with tight risk controls.",
    riskLevel: "HIGH",
    tags: ["momentum", "leveraged", "trend"],
    defaultConfig: {
      ...baseConfig,
      feesBps: 16,
      slippageBps: 12,
  ...
  {
    slug: "sol_spike_catcher",
    displayName: "SOL Spike Catcher",
    symbol: "SOLUSDT",
    timeframe: "15m",
    description: "Captures explosive price spikes on SOL with volume-confirmed breakout entries and quick exits.",
    riskLevel: "HIGH",
    tags: ["spike", "breakout", "high-vol"],
    defaultConfig: {
      ...baseConfig,
      feesBps: 17,
      slippageBps: 13,
...
export const STRATEGY_CATALOG: StrategyCatalogEntry[] = [
  ...
  {
    name: "XRP Stable Arb",
    description: "Statistical arbitrage on XRP using mean deviation in calm market conditions.",
    riskTier: "LOW",
    baseAsset: "USDT",
    pairsJson: ["XRP/USDT"],
    expectedMonthlyRangeBpsMin: 180,
    expectedMonthlyRangeBpsMax: 320,
    feesJson: { management: "0.3%", performance: "7%" },
    termsJson: { profitPayout: "DAILY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-1.5%",
    maxDrawdown: "-4.0%",
  ...
  {
    name: "BNB Range Harvest",
    description: "Yield harvesting from BNB price oscillations within established channels.",
    riskTier: "LOW",
    baseAsset: "USDT",
    pairsJson: ["BNB/USDT"],
    expectedMonthlyRangeBpsMin: 200,
    expectedMonthlyRangeBpsMax: 340,
    feesJson: { management: "0.4%", performance: "8%" },
    termsJson: { profitPayout: "DAILY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-1.8%",
  ...
  {
    name: "ETH Grid Scalp",
    description: "Grid-based scalping on ETH with dynamic entry levels and volume filters.",
    riskTier: "CORE",
    baseAsset: "USDT",
    pairsJson: ["ETH/USDT"],
    expectedMonthlyRangeBpsMin: 400,
    expectedMonthlyRangeBpsMax: 650,
    feesJson: { management: "0.5%", performance: "11%" },
    termsJson: { profitPayout: "MONTHLY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-6.0%",
    maxDrawdown: "-14.0%",
  ...
  {
    name: "ADA MACD Cross",
    description: "MACD crossover momentum strategy on ADA with histogram confirmation.",
    riskTier: "CORE",
    baseAsset: "USDT",
    pairsJson: ["ADA/USDT"],
    expectedMonthlyRangeBpsMin: 340,
    expectedMonthlyRangeBpsMax: 560,
    feesJson: { management: "0.5%", performance: "10%" },
    termsJson: { profitPayout: "MONTHLY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-5.5%",
  ...
  {
    name: "BTC Lev Momentum",
    description: "Leveraged momentum strategy on BTC capturing strong directional moves.",
    riskTier: "HIGH",
    baseAsset: "USDT",
    pairsJson: ["BTC/USDT"],
    expectedMonthlyRangeBpsMin: 650,
    expectedMonthlyRangeBpsMax: 1100,
    feesJson: { management: "0.8%", performance: "16%" },
    termsJson: { profitPayout: "MONTHLY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-12.0%",
    maxDrawdown: "-26.0%",
  ...
  {
    name: "SOL Spike Catcher",
    description: "Captures explosive SOL price spikes with volume-confirmed entries and rapid exits.",
    riskTier: "HIGH",
    baseAsset: "USDT",
    pairsJson: ["SOL/USDT"],
    expectedMonthlyRangeBpsMin: 700,
    expectedMonthlyRangeBpsMax: 1200,
    feesJson: { management: "0.8%", performance: "17%" },
    termsJson: { profitPayout: "MONTHLY", principalRedemption: "WEEKLY_WINDOW" },
    minInvestment: "100000000",
    worstMonth: "-13.0%",
    maxDrawdown: "-28.0%",
