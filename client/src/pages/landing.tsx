...
export default function Landing() {
  ...
  const handleDemoLogin = () => {
    window.location.href = "/api/demo-login?returnTo=/";
  };
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container max-w-6xl mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" onClick={handleDemoLogin} data-testid="button-demo-login-header">
              Demo Access
            </Button>
        ...
        <section className="container max-w-6xl mx-auto px-4 py-24 md:py-32">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="ghost" onClick={handleAdminLogin} data-testid="button-admin-login-hero">
                Admin Login
              </Button>
            </div>
          </div>
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="flex flex-col items-center text-center py-12 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button variant="outline" onClick={handleDemoLogin} data-testid="button-demo-cta">
                  Explore Demo
                </Button>
                <Button variant="ghost" onClick={handleAdminLogin} data-testid="button-admin-login-cta">
                  Admin Login
                </Button>
              </div>
            </CardContent>
