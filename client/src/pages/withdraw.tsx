...
import { formatMoney, parseMoney, AddressStatus, normalizeAddressStatus, type BootstrapResponse, type WhitelistAddress } from "@shared/schema";
...
export default function Withdraw() {
  ...
  const activeWhitelist = whitelist?.filter((w) => normalizeAddressStatus(w.status) === AddressStatus.ACTIVE) || [];
