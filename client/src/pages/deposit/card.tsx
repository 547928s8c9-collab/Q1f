...
export default function DepositCard() {
  ...
  const handleMoonpayOpen = () => {
    ...
    window.open(`https://buy.moonpay.com?apiKey=${apiKey}&currencyCode=usdt_trc20&baseCurrencyAmount=${moonpayAmountNum}`, "_blank");
  };
      ...
      <Card className="p-5 mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center px-2 py-0.5 rounded border text-xs font-bold tracking-wide text-blue-700 border-blue-300 bg-blue-50">VISA</span>
            <span className="inline-flex items-center px-2 py-0.5 rounded border text-xs font-bold tracking-wide text-orange-600 border-orange-300 bg-orange-50">MC</span>
          </div>
          ...
          <Button
            ...
            data-testid="button-moonpay-open"
          >
            Перейти к оплате →
          </Button>
        </div>
        ...
        {onramperOpen && (
          <div className="mt-4 space-y-3">
            <p className="text-sm text-muted-foreground">
              Если MoonPay не принимает вашу карту, свяжитесь с нами в Telegram — поможем
              пополнить через локального партнёра.
            </p>
